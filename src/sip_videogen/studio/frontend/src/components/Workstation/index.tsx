...
//Keyboard shortcuts: K=keep (only for unsorted), T=trash, Left/Right=navigate
...
return()=>window.removeEventListener('keydown',handleKeyDown)},[isTrashView,hasImages,isComparison,isKept,handleKeep,handleTrash,selectedIndex,currentBatch.length,setSelectedIndex])
//Show trash view
