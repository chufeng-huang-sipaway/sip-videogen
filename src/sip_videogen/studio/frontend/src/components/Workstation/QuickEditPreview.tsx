...
<Button variant="ghost" size="icon" onClick={handleContinueEdit} disabled={!editPrompt.trim()} className="h-7 w-7 rounded-full text-brand-400 hover:bg-white/15 disabled:opacity-30"><Send className="w-3.5 h-3.5"/></Button>
</div>)}
</div>)}
</>)
}
