...
const[browseMode,setBrowseModeState]=useState<BrowseMode>('preview')
...
const setBrowseMode=useCallback((mode:BrowseMode)=>{setBrowseModeState(mode)},[])
return(<WorkstationContext.Provider value={{currentBatch,selectedIndex,viewMode,comparisonSource,unsortedImages,isTrashView,statusVersion,browseMode,setCurrentBatch,setSelectedIndex,setViewMode,setComparisonSource,addToUnsorted,removeFromUnsorted,clearCurrentBatch,setIsTrashView,bumpStatusVersion,updateImagePath,setBrowseMode}}>{children}</WorkstationContext.Provider>)}
