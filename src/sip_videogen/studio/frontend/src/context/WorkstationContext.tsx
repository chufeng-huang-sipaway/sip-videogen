...
return(<WorkstationContext.Provider value={{...state,setCurrentBatch,setSelectedIndex,clearCurrentBatch,bumpStatusVersion,updateImagePath,setBrowseMode,removeFromBatchByPath,markAsViewed}}>{children}</WorkstationContext.Provider>)}
