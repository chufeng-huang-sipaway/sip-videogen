...
return(<WorkstationContext.Provider value={{currentBatch,selectedIndex,viewMode,comparisonSource,unsortedImages,isTrashView,setCurrentBatch,setSelectedIndex,setViewMode,setComparisonSource,addToUnsorted,removeFromUnsorted,clearCurrentBatch,setIsTrashView}}>{children}</WorkstationContext.Provider>)}
