...
export interface GeneratedImage{id:string;path:string;originalPath?:string;prompt?:string;sourceTemplatePath?:string;timestamp:string}
...
return(<WorkstationContext.Provider value={{...state,setCurrentBatch,setSelectedIndex,clearCurrentBatch,bumpStatusVersion,updateImagePath,setBrowseMode,removeFromBatchByPath}}>{children}</WorkstationContext.Provider>)}
