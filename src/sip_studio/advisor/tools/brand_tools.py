...
def _impl_list_projects() -> str:
    ...
    from sip_studio.brands.storage import get_active_project as storage_get_active_project
...
def _impl_get_product_detail(product_slug: str) -> str:
    ...
    from sip_studio.brands.memory import get_product_full
...
def _impl_get_project_detail(project_slug: str) -> str:
    ...
    from sip_studio.brands.memory import get_project_full
    from sip_studio.brands.storage import get_active_project as storage_get_active_project
...
def _impl_fetch_brand_detail(
    ...
    from sip_studio.brands.memory import get_brand_detail
