...
**Real Environments:**
Use when storytelling and context matter. Examples:
...
**Solid/Minimal Backdrops:**
Use when product is the sole focus. Choose colors that:
...
Feature brand colors prominently through:
- Background color
