...
from sip_studio.generators.base import BaseVideoGenerator, VideoProvider
...
class VideoGeneratorFactory:
    ...
    def _create_kling_generator(settings, prefs: UserPreferences) -> BaseVideoGenerator:
        ...
        from sip_studio.generators.kling_generator import KlingConfig, KlingVideoGenerator
    ...
    def _create_sora_generator(settings, prefs: UserPreferences) -> BaseVideoGenerator:
        ...
        from sip_studio.generators.sora_generator import SoraConfig, SoraVideoGenerator
