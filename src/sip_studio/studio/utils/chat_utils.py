...
from sip_studio.advisor.image_analyzer import analyze_image, format_analysis_for_message
...
async def analyze_and_format_attachments(
    ...
    from sip_studio.advisor.image_analyzer import ImageAnalysisResult
