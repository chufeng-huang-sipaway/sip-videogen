...
from sip_studio.brands import storage

from ..state import BridgeState
from ..utils.bridge_types import ALLOWED_TEXT_EXTS, bridge_error, bridge_ok
    ...
    def upload_document(self, filename: str, data_base64: str) -> dict:
        ...
        try:
            ...
            if target_path.exists():
                return bridge_error(f"File already exists: {filename}")
