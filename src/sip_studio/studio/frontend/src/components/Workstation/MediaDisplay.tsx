...
{!loading&&!error&&videoSrc&&(<video controls autoPlay className="absolute inset-0 w-full h-full object-contain rounded-lg shadow-lg" src={videoSrc} onError={()=>setError('Playback failed')}/>)}
</div></div>
{/* Navigation buttons */}
