    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="max-w-md w-full space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold">Welcome to Sip Studio</h1>
        ...
        <p className="text-xs text-center text-muted-foreground/60">Keys are saved locally in ~/.sip-studio/config.json</p>
      </div>
    </div>
  )
}
