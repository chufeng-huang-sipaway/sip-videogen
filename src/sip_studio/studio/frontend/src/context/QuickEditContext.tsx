...
const res=await bridge.chat(`Edit this image: ${prompt}`,[att],{project_slug:null,attached_products:prods.length>0?prods:undefined,image_aspect_ratio:aspectRatio})
