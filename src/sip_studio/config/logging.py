...
def setup_logging(
    ...
    Returns:
        The configured root logger for the sip_studio package.
    """
    log_level = getattr(logging, level.upper())

    # Create the package logger
    logger = logging.getLogger("sip_studio")
...
def get_logger(name: str | None = None) -> logging.Logger:
    ...
    Args:
        name: Module name (e.g., "sip_studio.agents"). If None, returns
    ...
    """
    if name is None:
        return logging.getLogger("sip_studio")
