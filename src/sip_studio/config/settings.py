...
USER_CONFIG_DIR = Path.home() / ".sip-studio"
...
class Settings(BaseSettings):
    ...
    kling_access_key: str | None = Field(
        default=None, description="Kling API access key (optional)"
    )
    kling_secret_key: str | None = Field(
        default=None, description="Kling API secret key (optional)"
    )
    # FireCrawl API key (optional, for URL content fetching)
    firecrawl_api_key: str | None = Field(
        default=None, description="FireCrawl API key (optional, enables URL reading)"
    )
    ...
    def is_configured(self) -> dict[str, bool]:
        ...
        return {
            ...
            "firecrawl_api": bool(self.firecrawl_api_key),
        }
