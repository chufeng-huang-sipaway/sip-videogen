...
from sip_studio.brands.product_description import extract_attributes_from_description
...
"""
    ...
    def _build_v2_context(self, name: str, slug: str, description: str, analysis) -> str:
        ...
        from sip_studio.advisor.style_reference_prompt import build_style_reference_constraints_v2
...
"""
    ...
    def _build_v3_context(self, name: str, slug: str, description: str, analysis) -> str:
        ...
        from sip_studio.advisor.style_reference_prompt import build_style_reference_constraints_v3
...
"""
    ...
    def _build_v1_context(self, name: str, slug: str, description: str, analysis) -> str:
        ...
        from sip_studio.advisor.style_reference_prompt import build_style_reference_constraints
