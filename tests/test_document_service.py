...
class TestGetDocuments:
    ...
    def test_returns_documents_list(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.document_service.storage.list_documents",return_value=["doc1.txt","doc2.md"]):
    ...
    def test_uses_provided_slug(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.list_documents",return_value=[])as mock_list:
    ...
    def test_error_when_no_brand(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",return_value=None):
            result=service.get_documents()
        assert result["success"]==False
        assert "No brand selected"in result["error"]
    def test_handles_exception(self,service):
        """Should return error on exception."""
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",side_effect=Exception("Storage error")):
            result=service.get_documents()
        assert result["success"]==False
...
class TestUploadDocument:
    ...
    def test_uploads_document(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.document_service.storage.get_docs_dir")as mock_docs:
                mock_docs.return_value=MagicMock(exists=MagicMock(return_value=False),__truediv__=lambda s,f:MagicMock(exists=MagicMock(return_value=False)))
                with patch("sip_videogen.studio.services.document_service.storage.save_document",return_value=("docs/test.txt",None)):
...
class TestDeleteDocument:
    ...
    def test_deletes_document(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.document_service.storage.delete_document",return_value=(True,None)):
    ...
    def test_returns_storage_error(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.document_service.storage.delete_document",return_value=(False,"File not found")):
...
class TestRenameDocument:
    ...
    def test_renames_document(self,service):
        ...
        with patch("sip_videogen.studio.services.document_service.storage.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.document_service.storage.rename_document",return_value=("docs/new.txt",None)):
...
class TestOpenDocumentInFinder:
    ...
    def test_opens_document(self,service,state,mock_brand_dir):
        ...
        state.get_brand_dir=MagicMock(return_value=(mock_brand_dir,None))
        with patch("sip_videogen.studio.services.document_service.reveal_in_file_manager")as mock_reveal:
