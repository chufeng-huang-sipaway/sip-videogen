...
class TestGetAssets:
    ...
    def test_returns_asset_tree(self,service):
        ...
        with patch("sip_videogen.studio.services.asset_service.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.asset_service.list_brand_assets",return_value=mock_assets):
    ...
    def test_uses_provided_slug(self,service):
        ...
        with patch("sip_videogen.studio.services.asset_service.list_brand_assets",return_value=[])as mock_list:
    ...
    def test_error_when_no_brand(self,service):
        ...
        with patch("sip_videogen.studio.services.asset_service.get_active_brand",return_value=None):
            result=service.get_assets()
...
class TestUploadAsset:
    ...
    def test_uploads_asset(self,service):
        ...
        with patch("sip_videogen.studio.services.asset_service.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.asset_service.storage_save_asset",return_value=("generated/test.png",None)):
    ...
    def test_returns_storage_error(self,service):
        ...
        with patch("sip_videogen.studio.services.asset_service.get_active_brand",return_value="test"):
            with patch("sip_videogen.studio.services.asset_service.storage_save_asset",return_value=(None,"Write failed")):
...
class TestOpenAssetInFinder:
    ...
    def test_opens_asset(self,service,state,mock_brand_dir):
        ...
        png_path.write_bytes(b"test")
        state.get_brand_dir=MagicMock(return_value=(mock_brand_dir,None))
        with patch("sip_videogen.studio.services.asset_service.reveal_in_file_manager")as mock_reveal:
