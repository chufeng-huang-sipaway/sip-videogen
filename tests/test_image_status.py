...
import json
import pytest
from sip_videogen.studio.services.image_status import ImageStatusService,CURRENT_VERSION,STATUS_FILE_NAME
...
def temp_brands_dir(tmp_path:Path):
    ...
    with patch("sip_videogen.brands.storage.get_brands_dir",return_value=brands_dir):
        with patch("sip_videogen.studio.services.image_status.get_brand_dir",lambda slug:brands_dir/slug):
            yield brands_dir
@pytest.fixture
...
class TestRegisterImage:
    ...
    def test_register_creates_entry_with_unsorted_status(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_register_stores_prompt_and_source(self,service:ImageStatusService,temp_brands_dir:Path)->None:
        """Test that register_image stores optional prompt and source."""
        result=service.register_image("test-brand","/path/to/image.png",prompt="A cat",source_template_path="/path/to/template.png")
        assert result["success"]is True
        data=result["data"]
        assert data["prompt"]=="A cat"
        assert data["sourceTemplatePath"]=="/path/to/template.png"
    def test_register_generates_unique_ids(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_register_persists_to_file(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestGetStatus:
    ...
    def test_get_status_returns_entry(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestSetStatus:
    ...
    def test_set_status_to_trashed(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_set_status_back_to_unsorted(self,service:ImageStatusService,temp_brands_dir:Path)->None:
        ...
        assert result["data"]["keptAt"]is None
        assert result["data"]["trashedAt"]is None
    def test_set_status_timestamps_are_iso(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestListByStatus:
    ...
    def test_list_by_status_filters_correctly(self,service:ImageStatusService,temp_brands_dir:Path)->None:
        """Test that list_by_status filters by status."""
        r1=service.register_image("test-brand","/path/to/image1.png")
        r2=service.register_image("test-brand","/path/to/image2.png")
        r3=service.register_image("test-brand","/path/to/image3.png")
...
class TestUpdatePath:
    ...
    def test_update_path_changes_current_path(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_update_path_not_found(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestDeleteImage:
    ...
    def test_delete_image_removes_entry(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_delete_image_not_found(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestAtomicWrite:
    ...
    def test_atomic_write_no_temp_file_remains(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_file_not_corrupted_on_concurrent_reads(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestBackfillFromFolders:
    ...
    def test_backfill_creates_entries_from_generated(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_backfill_creates_entries_from_kept(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_backfill_creates_entries_from_trash(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_backfill_skips_existing_entries(self,service:ImageStatusService,temp_brands_dir:Path)->None:
    ...
    def test_backfill_ignores_non_image_files(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestCleanupOldTrash:
    ...
    def test_cleanup_keeps_recent_trashed_images(self,service:ImageStatusService,temp_brands_dir:Path)->None:
...
class TestLoadStatusData:
    ...
    def test_load_creates_empty_structure_if_missing(self,service:ImageStatusService,temp_brands_dir:Path)->None:
        """Test that loading creates empty structure if file missing."""
        result=service.list_by_status("test-brand","unsorted")
        assert result["success"]is True
        assert result["data"]==[]
    def test_load_handles_invalid_json(self,service:ImageStatusService,temp_brands_dir:Path)->None:
