...
class TestImageMetadataPersistence:
    ...
    def test_store_image_metadata_writes_json(self,tmp_path:Path)->None:
        ...
        from sip_videogen.advisor.tools import store_image_metadata,ImageGenerationMetadata
...
class TestGenerateVideoClip:
    ...
    def test_unsupported_provider_returns_error(self,tmp_path:Path)->None:
        ...
        with(
            ...
            patch("sip_videogen.advisor.tools.get_settings",return_value=MagicMock(gemini_api_key="fake")),
        ):
...
class TestVideoPromptEngineeringSkill:
    ...
    def test_skill_file_exists(self)->None:
        ...
        from pathlib import Path
        skill_path=Path(__file__).parent.parent/"src"/"sip_videogen"/"advisor"/"skills"/"video_prompt_engineering"/"SKILL.md"
