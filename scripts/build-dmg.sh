#!/bin/bash
# Build DMG installer for Sip Studio
# Prerequisites: Build the .app first: python setup.py py2app (or py2app --alias for dev)
...
APP_NAME="Sip Studio"
VERSION="0.9.0"
DMG_NAME="Sip-Studio-${VERSION}.dmg"
...
if [ ! -d "$APP_PATH" ]; then
    ...
    echo "  cd src/sip_studio/studio/frontend && npm run build && cd -"
...
echo "  3. Drag Sip Studio to Applications"
